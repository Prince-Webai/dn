...
const Dashboard = () => {
    ...
    const statCards = [
        ...
        },
        {
            ...
            icon: Wrench,
            color: 'bg-[#E6F9F3] text-[#00A862]', // green
        ...
        },
        {
            ...
            icon: AlertCircle,
            color: 'bg-[#FFE6E6] text-[#DC3545]', // red
            change: `${stats.overdueInvoices} invoices`,
            changeType: 'negative'
        },
        {
            label: 'Parts Alerts',
            ...
            icon: Package,
            color: 'bg-[#FFF3E6] text-[#FF6B00]', // orange
            change: 'To 18 jobs', // Mock data from prototype
            changeType: 'positive'
        }
    ];
