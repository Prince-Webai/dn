                    ...
                    <>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            onChange={e => setSettings(prev => prev ? { ...prev, contact_name: e.target.value } : { id: '00000000-0000-0000-0000-000000000000', company_name: '', company_address: '', company_phone: '', company_email: '', contact_name: e.target.value, bank_name: '', account_name: '', iban: '', bic: '', vat_reg_number: '', default_vat_rate: 13.5, webhook_url: '', updated_at: new Date().toISOString() })}
                                        />
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-1.5 ml-1">Default VAT Rate (%)</label>
                                    <p className="text-xs text-slate-500 mb-2 ml-1">Standard rate applied to new invoices (e.g. 13.5 or 23).</p>
                                    <div className="relative">
                                        <Receipt size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" />
                                        <input
                                            type="number"
                                            ...
                                            onChange={e => setSettings(prev => prev ? { ...prev, default_vat_rate: parseFloat(e.target.value) } : null)}
                                        />
                                    </div>
                                </div>
                            </div>
